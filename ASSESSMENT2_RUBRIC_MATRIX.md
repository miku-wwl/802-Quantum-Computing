...
| Task 4 | 15% | Circuit/input/problem formulation thoroughly analysed; per-iteration metric/time plots; local non-quantum version; efficiency/effectiveness comparison; comprehensive Word report | PASS |

## Global submission checks

- [x] Distinct folder for every task.
- [x] Clear notebook headings and subheadings.
- [x] All notebook cells execute from a clean kernel.
- [x] Relevant diagrams, figures, and equations are present.
- [x] Sources use one consistent citation style.
